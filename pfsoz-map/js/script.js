...
var Worldmap = L.tileLayer("tiles/{z}_{x}_{y}.gif", {
  minNativeZoom: 1,
  minZoom: 1,
  maxNativeZoom: 4, //4
  maxZoom: 8, //+2
...
L.control
  .layers({
    "<span id='layer-WorldMap'>世界地図</span>": Worldmap,
    "<span id='layer-CapitalMap'>首都詳細</span>": Capitalmap,
  })
  .addTo(map);

$(function () {
  $("#layer-WorldMap").click(function () {
    const layerMarker = document.querySelector(".leaflet-marker-pane");
    const layerMinimap = document.querySelector(".leaflet-control-minimap");
    const layerPopup = document.querySelector(".leaflet-popup-pane");
    const layerGapFill = document.querySelector(".leaflet-gap-fill-pane");
    layerMarker.style.display = "block";
    layerMinimap.style.display = "block";
    layerPopup.style.display = "block";
    layerGapFill.style.display = "block";
  });
});

$(function () {
  $("#layer-CapitalMap").click(function () {
    const layerMarker = document.querySelector(".leaflet-marker-pane");
    const layerMinimap = document.querySelector(".leaflet-control-minimap");
    const layerPopup = document.querySelector(".leaflet-popup-pane");
    const layerGapFill = document.querySelector(".leaflet-gap-fill-pane");
    layerMarker.style.display = "none";
    layerMinimap.style.display = "none";
    layerPopup.style.display = "none";
    layerGapFill.style.display = "none";
  });
});
